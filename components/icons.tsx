...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M12 2a2.5 2.5 0 0 0-2.5 2.5v.1a2.5 2.5 0 0 0-2.2 2.4V9a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h.1a2.5 2.5 0 0 0 2.4 2.2v.1a2.5 2.5 0 0 0 2.5 2.5h.1a2.5 2.5 0 0 0 2.4-2.2v-.1a2.5 2.5 0 0 0 2.2-2.4V13a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-.1A2.5 2.5 0 0 0 16.5 4.6V4.5A2.5 2.5 0 0 0 14 2z" />
    <path d="M4.5 9.5h-.1" />
    <path d="M4.5 14.5h-.1" />
    <path d="M9.5 4.5v-.1" />
    <path d="M9.5 19.5v.1" />
    <path d="M14.5 4.5v-.1" />
    <path d="M14.5 19.5v.1" />
    <path d="M19.5 9.5h.1" />
    <path d="M19.5 14.5h.1" />
  </svg>
);
...
export const WalkIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
      ...
      <path d="m6 12 2-4 3 4 3-4 2 4" />
      <path d="M17 20a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2" />
    </svg>
);
